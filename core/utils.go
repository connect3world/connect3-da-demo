...
// this hardcodes abi.encode() for cstaskmanager.IConnect3DATaskManagerTaskResponse
// unclear why abigen doesn't provide this out of the box...
func AbiEncodeTaskResponse(h *cstaskmanager.IConnect3DATaskManagerTaskResponse) ([]byte, error) {

	// The order here has to match the field ordering of cstaskmanager.IConnect3DATaskManagerTaskResponse
...
func GetTaskResponseDigest(h *cstaskmanager.IConnect3DATaskManagerTaskResponse) ([32]byte, error) {
