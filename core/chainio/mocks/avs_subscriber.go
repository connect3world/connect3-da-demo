...
// Source: github.com/Layr-Labs/connect3-da-avs/core/chainio (interfaces: AvsSubscriberer)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/avs_subscriber.go -package=mocks github.com/Layr-Labs/connect3-da-avs/core/chainio AvsSubscriberer
//
...
func (m *MockAvsSubscriberer) ParseTaskResponded(arg0 types.Log) (*contractConnect3DATaskManager.ContractConnect3DATaskManagerTaskResponded, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseTaskResponded", arg0)
	ret0, _ := ret[0].(*contractConnect3DATaskManager.ContractConnect3DATaskManagerTaskResponded)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAvsSubscriberer) SubscribeToNewTasks(arg0 chan *contractConnect3DATaskManager.ContractConnect3DATaskManagerNewTaskCreated) event.Subscription {
	m.ctrl.T.Helper()
...
func (m *MockAvsSubscriberer) SubscribeToTaskResponses(arg0 chan *contractConnect3DATaskManager.ContractConnect3DATaskManagerTaskResponded) event.Subscription {
	m.ctrl.T.Helper()
