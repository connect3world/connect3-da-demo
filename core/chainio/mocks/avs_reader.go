...
// Source: github.com/Layr-Labs/connect3-da-avs/core/chainio (interfaces: AvsReaderer)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/avs_reader.go -package=mocks github.com/Layr-Labs/connect3-da-avs/core/chainio AvsReaderer
//
...
import (
	...
	contractERC20Mock "github.com/connect3world/c3-data-avs/contracts/bindings/ERC20Mock"
...
func (m *MockAvsReaderer) CheckSignatures(arg0 context.Context, arg1 [32]byte, arg2 []byte, arg3 uint32, arg4 contractConnect3DATaskManager.IBLSSignatureCheckerNonSignerStakesAndSignature) (contractConnect3DATaskManager.IBLSSignatureCheckerQuorumStakeTotals, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckSignatures", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(contractConnect3DATaskManager.IBLSSignatureCheckerQuorumStakeTotals)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
