...
// Source: github.com/Layr-Labs/connect3-da-avs/core/chainio (interfaces: AvsWriterer)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/avs_writer.go -package=mocks github.com/Layr-Labs/connect3-da-avs/core/chainio AvsWriterer
//
...
import (
	...
	contractConnect3DATaskManager "github.com/connect3world/c3-data-avs/contracts/bindings/Connect3DATaskManager"
...
func (m *MockAvsWriterer) RaiseChallenge(arg0 context.Context, arg1 contractConnect3DATaskManager.IConnect3DATaskManagerTask, arg2 contractConnect3DATaskManager.IConnect3DATaskManagerTaskResponse, arg3 contractConnect3DATaskManager.IConnect3DATaskManagerTaskResponseMetadata, arg4 []contractConnect3DATaskManager.BN254G1Point) (*types0.Receipt, error) {
	m.ctrl.T.Helper()
...
func (m *MockAvsWriterer) SendAggregatedResponse(arg0 context.Context, arg1 contractConnect3DATaskManager.IConnect3DATaskManagerTask, arg2 contractConnect3DATaskManager.IConnect3DATaskManagerTaskResponse, arg3 contractConnect3DATaskManager.IBLSSignatureCheckerNonSignerStakesAndSignature) (*types0.Receipt, error) {
	m.ctrl.T.Helper()
...
// SendNewTaskAddressToC3Data mocks base method.
func (m *MockAvsWriterer) SendNewAddressToFetchC3Data(arg0 context.Context, arg1 common.Address, arg2 types.QuorumThresholdPercentage, arg3 types.QuorumNums) (contractConnect3DATaskManager.IConnect3DATaskManagerTask, uint32, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendNewAddressToFetchC3Data", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(contractConnect3DATaskManager.IConnect3DATaskManagerTask)
	ret1, _ := ret[1].(uint32)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}

// SendNewTaskAddressToC3Data indicates an expected call of SendNewTaskAddressToC3Data.
func (mr *MockAvsWritererMockRecorder) SendNewTaskAddressToC3Data(arg0, arg1, arg2, arg3 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendNewAddressToFetchC3Data", reflect.TypeOf((*MockAvsWriterer)(nil).SendNewAddressToFetchC3Data), arg0, arg1, arg2, arg3)
}
