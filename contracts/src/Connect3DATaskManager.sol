...
contract Connect3DATaskManager is
    Initializable,
    OwnableUpgradeable,
    Pausable,
    BLSSignatureChecker,
...
IConnect3DATaskManager
{
    ...
    function createNewTask(
        address addressToFetchC3Data,
        uint32 quorumThresholdPercentage,
        bytes calldata quorumNumbers
    ) external onlyTaskGenerator {
        // create a new task struct
        Task memory newTask;
        newTask.addressToFetchC3Data = addressToFetchC3Data;
    ...
    function raiseAndResolveChallenge(
        ...
        address addressToFetchC3Data = task.addressToFetchC3Data;
        // some logical checks
        require(
        ...
        bool isResponseCorrect = (addressToFetchC3Data ==
            taskResponse.addressInResponse);
