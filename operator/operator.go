...
import (
	...
	"github.com/connect3world/c3-data-avs/metrics"
...
type Operator struct {
	...
	c3DAServiceManagerAddr common.Address
}
...
func NewOperatorFromConfig(c types.NodeConfig) (*Operator, error) {
	...
	operator := &Operator{
		...
		c3DAServiceManagerAddr:     common.HexToAddress(c.AVSRegistryCoordinatorAddress),
...
func (o *Operator) ProcessNewTaskCreatedLog(newTaskCreatedLog *cstaskmanager.ContractConnect3DATaskManagerNewTaskCreated) *cstaskmanager.IConnect3DATaskManagerTaskResponse {
	o.logger.Debug("Received new task", "task", newTaskCreatedLog)
	o.logger.Info("Received new task",
		"AddressToFetchC3Data", newTaskCreatedLog.Task.AddressToFetchC3Data,
	...
	result, err := o.fetchC3Data(newTaskCreatedLog.Task.AddressToFetchC3Data.Hex())
	if err != nil {
		o.logger.Error("Failed to fetch data from GraphQL API", "err", err)
		return nil
	}

	// Calculate the hash of the data
	dataHash, err := o.calculateDataHash(result)
	if err != nil {
		o.logger.Error("Failed to calculate data hash", "err", err)
		return nil
	}

	o.logger.Info("Fetched data from GraphQL API", "data", result)
	o.logger.Info("Data hash", "dataHash", dataHash)

	taskResponse := &cstaskmanager.IConnect3DATaskManagerTaskResponse{
		ReferenceTaskIndex: newTaskCreatedLog.TaskIndex,
		AddressInResponse:  newTaskCreatedLog.Task.AddressToFetchC3Data,
		C3DataHash:         dataHash,
	}
	return taskResponse
}

func (o *Operator) SignTaskResponse(taskResponse *cstaskmanager.IConnect3DATaskManagerTaskResponse) (*aggregator.SignedTaskResponse, error) {
...
func (o *Operator) fetchC3Data(address string) (map[string]interface{}, error) {
	apiUrl := "https://connect3.world/api/graphql"
	query := `
		query GetArticlesList($where: ArticleWhereInput, $take: Int, $skip: Int, $orderBy: [ArticleOrderByWithRelationInput!], $distinct: [ArticleScalarFieldEnum!], $cursor: ArticleWhereUniqueInput) {
		  articles(
			where: $where
			take: $take
			skip: $skip
	...
	variables := map[string]interface{}{
		...
		"orderBy":  map[string]interface{}{"publishedOn": "desc"},
		"distinct": "id",
	}
...
func (o *Operator) calculateDataHash(data map[string]interface{}) ([32]byte, error) {
